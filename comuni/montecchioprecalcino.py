### Comune di montecchioprecalcino###
### Sostituisci "montecchioprecalcino" con il nome del Comune ###
...
# 🔧 CONFIGURAZIONE
COMUNE = "montecchioprecalcino"
BASE_URL = f"https://www.comune.{COMUNE}.vi.it"
FEED_FILE = f"feeds/{COMUNE}1.xml"
...
async def fetch_news():
    async with async_playwright() as p:
        ...
        blocks = await page.query_selector_all("div.no-after.rounded")
        ...
        for block in blocks[:10]:
            ...
            if title.lower() in ["avvisi", "notizie", "comunicati", "demografia e popolazione", "ambiente", "speciali"]:
                continue
