###  Sostituisci bassano con il nome del Comune ###
###  Comune di bassano
...
FEED_FILE = "feeds/bassano.xml"
URL = "https://www.comune.bassano.vi.it/home/novita"
    ...
    async with async_playwright() as p:
        ...
        for block in blocks[:10]:
            ...
            if link and link.startswith("/"):
                link = "https://www.comune.bassano.vi.it" + link
            ...
            if img_el:
                ...
                if img_src and img_src.startswith("/"):
                    img_src = "https://www.comune.bassano.vi.it" + img_src
...
def generate_feed(site=None):
    ...
    ET.SubElement(channel, "title").text = "Comune di bassano - Notizie"
    ET.SubElement(channel, "link").text = URL
    ET.SubElement(channel, "description").text = "Ultime notizie dal sito ufficiale del Comune di bassano"
