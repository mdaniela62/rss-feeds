### Comune di arcugnano ###
### Sostituisci "arcugnano" con il nome del Comune ###
...
async def fetch_news():
    async with async_playwright() as p:
        ...
        blocks = await page.query_selector_all("div.shadow-sm.rounded")
        ...
        for block in blocks[:10]:
            ...
            if title.lower() in ["avvisi", "notizie", "comunicati", "elettorale", "sport","istruzione"]:
                continue
