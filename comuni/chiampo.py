### Comune di chiampo###
### Sostituisci "chiampo" con il nome del Comune ###
...
SOURCE_URL = f"{BASE_URL}/it/novita"
...
async def fetch_news():
    async with async_playwright() as p:
        ...
        #blocks = await page.query_selector_all("div.row.g-3.gx-xl-4 > div.col-md-6.col-xl-4")

        # Trova il form di ricerca
        form = await page.query_selector("form")

        # Trova il contenitore subito dopo il form
        notizie_container = await form.evaluate_handle("el => el.nextElementSibling")

        # Seleziona solo le notizie da quel contenitore
        blocks = await notizie_container.query_selector_all(".col-md-6.col-xl-4")
