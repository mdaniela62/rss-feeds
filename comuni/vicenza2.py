...
FEED_FILE = "feeds/vicenza2.xml"
URL = "https://www.comune.vicenza.it/Servizi"
...
async def fetch_news():
    async with async_playwright() as p:
        ...
        blocks = await page.query_selector_all("div.col-md-6.col-lg-4.mb-4")
...
def generate_feed(site=None):
    ...
    ET.SubElement(channel, "title").text = "Comune di Vicenza - Servizi"
