...
async def fetch_news():
    async with async_playwright() as p:
        ...
        blocks = await page.query_selector_all("div.col-md-4.news-block")
        ...
        for block in blocks[:10]:
            ...
            if link and link.startswith("/"):
                link = "https://www.comune.orgiano.vi.it" + link
...
def generate_feed(site=None):
    ...
    ET.SubElement(channel, "title").text = "Comune di orgiano - Notizie"
    ET.SubElement(channel, "link").text = URL
    ET.SubElement(channel, "description").text = "Ultime notizie dal sito ufficiale del Comune di orgiano"
