###  Sostituisci santorso con il nome del Comune ###
###  Comune di santorso
...
FEED_FILE = "feeds/santorso.xml"
URL = "https://www.comune.santorso.vi.it/Novita"
    ...
    async with async_playwright() as p:
        ...
        for block in blocks[:10]:
            ...
            if link and link.startswith("/"):
                link = "https://www.comune.santorso.vi.it" + link
            ...
            if img_el:
                ...
                if img_src and img_src.startswith("/"):
                    img_src = "https://www.comune.santorso.vi.it" + img_src
...
def generate_feed(site=None):
    ...
    ET.SubElement(channel, "title").text = "Comune di santorso - Notizie"
    ET.SubElement(channel, "link").text = URL
    ET.SubElement(channel, "description").text = "Ultime notizie dal sito ufficiale del Comune di santorso"
