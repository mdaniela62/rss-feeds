...
FEED_FILE = "feeds/thiene.xml"
URL = "https://www.comune.thiene.vi.it/home/novita"
...
async def fetch_news():
    async with async_playwright() as p:
        ...
        await asyncio.sleep(2)  # attesa extra per contenuti JS       
        ...
        for block in blocks[:5]:  # solo le prime 5 notizie
            ...
            if link and link.startswith("/"):
                link = "https://www.comune.thiene.vi.it" + link
