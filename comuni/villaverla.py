    ...
    async with async_playwright() as p:
        ...
        for block in blocks[:10]:
            ...
            if link and link.startswith("/"):
                link = "https://www.comune.villaverla.vi.it" + link
...
def generate_feed(site=None):
    ...
    ET.SubElement(channel, "title").text = "Comune di villaverla - Notizie"
    ET.SubElement(channel, "link").text = URL
    ET.SubElement(channel, "description").text = "Ultime notizie dal sito ufficiale del Comune di villaverla"
