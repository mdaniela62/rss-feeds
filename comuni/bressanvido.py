...
FEED_FILE = "feeds/bressanvido.xml"
URL = "https://www.comune.bressanvido.vi.it/tuttenotizie"
    ...
    async with async_playwright() as p:
        ...
        for block in blocks[:10]:
            ...
            if link and link.startswith("/"):
                link = "https://www.comune.bressanvido.vi.it" + link
...
def generate_feed(site=None):
    ...
    ET.SubElement(channel, "title").text = "Comune di bressanvido - Notizie"
    ET.SubElement(channel, "link").text = URL
    ET.SubElement(channel, "description").text = "Ultime notizie dal sito ufficiale del Comune di bressanvido"
